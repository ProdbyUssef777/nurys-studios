...
export default function ReleaseRow({ release }: { release: Release }) {
  return (
    <div className="group grid grid-cols-[80px_1fr] items-start gap-5 border-b border-line py-6 md:grid-cols-[110px_1fr_auto] md:gap-8 md:py-8">
      ...
      <div className="min-w-0">
        ...
        <div className="mt-3 md:hidden">
          ...
          {release.links.spotify && <SpotifyEmbed spotifyUrl={release.links.spotify} />}
        </div>
      </div>
